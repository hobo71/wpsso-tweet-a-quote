 ...
 * Description: WPSSO Core add-on to provide Twitter-style quoted text to your content with a Tweet share link and customizable CSS.
 * Requires PHP: 5.4
	...
	class WpssoTaq {
		...
		private function min_version_notice() {
			...
			if ( method_exists( 'SucomUtil', 'safe_trigger_error' ) ) {
				...
				$error_prefix = sprintf( __( '%s warning:', 'wpsso-tweet-a-quote' ), $info['short'] );
