...
The WordPress Social Sharing Optimization (WPSSO) plugin is required to use the WPSSO TAQ extension.
...
(2016/12/11) Excluded the Twitter URL from the JavaScript popup protection for mobile devices.
